function createChart1(chartDom) {
...
function createChart2(chartDom) {
    var chart = echarts.init(chartDom);
...
function createChart3(chartDom) {
    var chart = echarts.init(chartDom);
    option = {
        series: [
          {
...
function createChart4(chartDom) {

  var chart1 = LightweightCharts.createChart(document.getElementById('chart-container'), {
    width: 600,
    height: 300,
    crosshair: {
