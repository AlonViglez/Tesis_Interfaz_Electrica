        ...
        .then(data => {
            ...
            if (data.time && Array.isArray(data.raw_data)) {
                ...
                data.raw_data.forEach((value, index) => {
                    ...
                    if (dataPointsSeries[index].length > 20) {
...
// Estado de visibilidad de las series
let seriesVisibility = {};
// Función para inicializar la visibilidad de las series
...
// Escucha el evento de cambio de selección de la leyenda
